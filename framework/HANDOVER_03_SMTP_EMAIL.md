...
async def test_smtp_connection(conn: Connection, test_email: str) -> Dict[str, Any]:
    ...
    try:
        await _send_smtp_email(
            ...
            plain_body="This is a test email from your Farm ERP. SMTP is configured correctly!",
            html_body="<h2>SMTP Test Email</h2><p>This is a test email from your Farm ERP.</p><p><strong>SMTP is configured correctly!</strong></p>"
        )
