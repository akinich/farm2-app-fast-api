...
The Farm ERP keeps you informed through multiple communication channels:
...
1. In Farm ERP, go to **Profile → Integrations**
...
API keys let you access the Farm ERP from:
- Custom scripts
- Mobile apps
- External tools
