...
2. Enter your SMTP server details:
   ...
   | From Name | `Farm ERP` | Display name for emails |
...
API Keys allow programmatic access to the Farm ERP API without user credentials.
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
        <tr>
            <td style="background: #4CAF50; padding: 20px; text-align: center;">
                <h1 style="color: white; margin: 0;">Farm ERP</h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="background: #f4f4f4; padding: 10px; text-align: center; font-size: 12px; color: #666;">
                <p>© 2025 Farm ERP. All rights reserved.</p>
            </td>
        </tr>
    </table>
</body>
