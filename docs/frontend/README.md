...
The Farm ERP frontend is built with React 18 and Material-UI, providing a modern, responsive user interface. It features robust authentication, state management with React Query and Zustand, and modular architecture for extensibility.
