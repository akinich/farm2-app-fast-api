...
This document provides a complete reference for all database migrations in the Farm ERP. Each migration is tracked, documented, and includes rollback procedures.
