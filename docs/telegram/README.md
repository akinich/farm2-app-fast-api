...
The Telegram Notifications Module provides real-time messaging capabilities to your Farm ERP through Telegram Bot API integration. It sends automated notifications for tickets, purchase orders, and inventory alerts to designated Telegram channels, ensuring your team stays informed about critical events as they happen.
